...
export type PlanetLabelScale = 'small' | 'medium' | 'large';

const SCALE_METERS: Readonly<Record<PlanetLabelScale, readonly [number, number]>> = Object.freeze({
  small: Object.freeze([0.72, 0.18]) as readonly [number, number],
  medium: Object.freeze([0.9, 0.225]) as readonly [number, number],
  large: Object.freeze([1.12, 0.28]) as readonly [number, number],
});
...
export function createPlanetLabelPlacement(
  ...
  return Object.freeze({
    ...
    scaleMeters: SCALE_METERS[scale],
  });
}
